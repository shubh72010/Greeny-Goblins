...
val RandomThumbnailShapeKey = booleanPreferencesKey("randomThumbnailShape")
...
val ShowMiniPlayerControlsKey = booleanPreferencesKey("showMiniPlayerControls")
...
val HapticVisualizerSensitivityKey = floatPreferencesKey("hapticVisualizerSensitivity")
val HapticVisualizerBeatSensitivityKey = floatPreferencesKey("hapticBeatSensitivity")

// Glyph visualizer (Nothing phones)
val GlyphVisualizerEnabledKey = booleanPreferencesKey("glyphVisualizerEnabled")
val GlyphBrightnessKey = intPreferencesKey("glyphBrightness")
val GlyphGammaKey = floatPreferencesKey("glyphGamma")
val GlyphIdleBreathingKey = booleanPreferencesKey("glyphIdleBreathing")
val GlyphPresetKey = stringPreferencesKey("glyphPreset")
val GlyphVisualizerGainKey = floatPreferencesKey("glyphVisualizerGain")

// Flashlight visualizer
val FlashlightVisualizerEnabledKey = booleanPreferencesKey("flashlightVisualizerEnabled")
val FlashlightModeKey = stringPreferencesKey("flashlightMode")
val FlashlightBeatEngineModeKey = stringPreferencesKey("flashlightBeatEngineMode")
val FlashlightThresholdKey = floatPreferencesKey("flashlightThreshold")
val FlashlightSensitivityKey = floatPreferencesKey("flashlightSensitivity")
val FlashlightBeatSpeedKey = floatPreferencesKey("flashlightBeatSpeed")
...
val AutoStartOnBluetoothAllowedDevicesKey = stringSetPreferencesKey("autoStartOnBluetoothAllowedDevices")
val AutoStartOnBluetoothDelaySecondsKey = intPreferencesKey("autoStartOnBluetoothDelaySeconds")
const val AutoStartOnBluetoothDelayDefault = 2
const val AutoStartOnBluetoothDelayMin = 1
const val AutoStartOnBluetoothDelayMax = 60
val AutoStartOnBluetoothDelayRange = AutoStartOnBluetoothDelayMin.toFloat()..AutoStartOnBluetoothDelayMax.toFloat()
...
val ShowHomeQuickPicksKey = booleanPreferencesKey("showHomeQuickPicks")
val ShowHomeSpeedDialKey = booleanPreferencesKey("showHomeSpeedDial")
val ShowHomeKeepListeningKey = booleanPreferencesKey("showHomeKeepListening")
val ShowHomeAccountPlaylistsKey = booleanPreferencesKey("showHomeAccountPlaylists")
val ShowHomeForgottenFavoritesKey = booleanPreferencesKey("showHomeForgottenFavorites")
val ShowHomeSimilarKey = booleanPreferencesKey("showHomeSimilar")
val ShowHomeRemoteSectionsKey = booleanPreferencesKey("showHomeRemoteSections")
