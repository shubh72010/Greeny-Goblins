    ...
    fun toScreenState(
        ...
        return HomeScreenState.Success(
            HomeUiState(
                ...
                showQuickPicks = preferences.showQuickPicks,
                showSpeedDial = preferences.showSpeedDial,
                showKeepListening = preferences.showKeepListening,
                showAccountPlaylists = preferences.showAccountPlaylists,
                showForgottenFavorites = preferences.showForgottenFavorites,
                showSimilar = preferences.showSimilar,
                showRemoteSections = preferences.showRemoteSections,
